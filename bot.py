...
async def HelpWatermark(bot, cmd):
	...
	await cmd.reply_text(
		...
		parse_mode="Markdown",
		reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/harshahero"), InlineKeyboardButton("Support Group", url="https://t.me/SENKUCHAT")], [InlineKeyboardButton("Bots Channel", url="https://t.me/SENKUBOTS")], [InlineKeyboardButton("Source Code", url="https://github.com/AbirHasan2005/Watermark-Bot")]]),
...
async def button(bot, cmd: CallbackQuery):
	...
	if "refreshmeh" in cb_data:
		...
		await cmd.message.edit(
			text=Config.USAGE_WATERMARK_ADDER,
			parse_mode="Markdown",
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/harshahero"), InlineKeyboardButton("Support Group", url="https://t.me/SENKUCHAT")], [InlineKeyboardButton("Bots Channel", url="https://t.me/SENKUBOTS")]]),
			disable_web_page_preview=True
		)
